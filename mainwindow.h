...
public:
    ...
    QCheckBox *sound3D[nbInstruMax];
    QCheckBox *reverb3D[nbInstruMax];
    ...
    QDoubleSpinBox *xPos[nbInstruMax];
    QDoubleSpinBox *yPos[nbInstruMax];
...
private:
    ...
    void playNow();
    int64_t loadMonoWavFile(QString fileName, float *&wavSound, bool &);
...
private slots:
    ...
    void sound3DChanged(QCheckBox* checkbox);
    void reverb3DChanged(QCheckBox* checkbox);
